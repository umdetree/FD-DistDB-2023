...
public interface WorkflowController extends Remote {
     ...
     *                  current price; leave price at 0 if price<0 for very first
     *                  add for this flight.
     ...
     * @param xid       id of transaction.
     * @param flightNum flight number, cannot be null.
     * @return true on success, false on failure. (flight doesn't exist;has
     *         reservations...)
     *
     * @throws RemoteException             on communications failure.
     * @throws TransactionAbortedException if transaction was aborted.
     ...
     *
     * @return true on success, false on failure. (location doesn't exist;
     *         numRooms<0; not enough available rooms...)
     *
     * @throws RemoteException             on communications failure.
     * @throws TransactionAbortedException if transaction was aborted.
     * @throws InvalidTransactionException if transaction id is invalid.
     ...
     * @param xid      id of transaction.
     * @param custName name of customer.
     * @return true on success, false on failure. (custName==null or doesn't
     *         exist...)
     *
     * @throws RemoteException             on communications failure.
     * @throws TransactionAbortedException if transaction was aborted.
    ...
    /**
     * Return the price of a seat on this flight. Return -1 if flightNum==null or
     * doesn't exist.
     */
    ...
    /*
     * Return the total price of all reservations held for a customer. Return -1 if
     * custName==null or doesn't exist.
     */
     ...
     * @param custName  name of customer.
     * @param flightNum flight number.
     * @return true on success, false on failure. (cust or flight doesn't exist; no
     *         seats left...)
     *
     * @throws RemoteException             on communications failure.
     * @throws TransactionAbortedException if transaction was aborted.
     ...
     * This method is used for testing and is not part of a transaction.
     *
     * @param who which component to kill; must be "TM", "RMFlights", "RMRooms",
     *            "RMCars", "RMCustomers", "WC", or "ALL" (which kills all 6 in that
     *            order).
     * @return true on success, false on failure.
     */
     ...
     * This method is used for testing and is not part of a transaction.
     *
     * @param who which RM to kill; must be "RMFlights", "RMRooms", "RMCars", or
     *            "RMCustomers".
     * @return true on success, false on failure.
     */
